...
**Fang et al. (2023) "EVA-02: A Visual Representation for Neon Genesis" (EVA-02)**
...
- **Touvron et al. (2021) "DeiT: Data-efficient Image Transformers"** — 用知识蒸馏在 ImageNet-1K 上训练 ViT，不需 JFT-300M 大规模数据。如果你手头只有 ImageNet-1K 级别数据，建议看看
- **Dosovitskiy et al. (2023) "NaViT"** — 让 ViT 支持动态分辨率输入（patchify + 打包训练）。对高分辨率/多分辨率输入感兴趣可翻翻
- **Zhu et al. (2024) "InternViT: Scaling Vision Foundation Models for Multimodal Understanding"** — 6B 参数视觉编码器，展示"视觉编码器越大越好"的 scaling 结论
...
| 论文 | 链接 |
|---|---|
| EVA-02: A Visual Representation for Neon Genesis | [arXiv](https://arxiv.org/abs/2303.11331) |
