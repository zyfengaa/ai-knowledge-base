...
**Gal et al. (2022) "An Image is Worth One Word: Textual Inversion for Personalized Image Generation"**
...
- **Ruiz et al. (2023) "DreamBooth: Fine Tuning Text-to-Image Diffusion Models for Subject-Driven Generation"** — 全量/部分微调的代表工作，用少量图让模型记住特定对象。与 LoRA 对比，DreamBooth 更强大但更重。
- **Ye et al. (2023) "IP-Adapter: Text Compatible Image Prompt Adapter for Text-to-Image Diffusion Models"** — 图像 prompt 控制的标准方案，解决了"以图生图"条件下高保真度控制的问题。
- **Mou et al. (2024) "T2I-Adapter: Learning Adapters to Dig out More Controllable Ability for Text-to-Image Diffusion Models"** — ControlNet 的轻量级替代方案。如果你关心"有没有比 ControlNet 更轻量的选择"，值得一看。
