...
| 解决的问题 | 留下的麻烦 |
|-----------|-----------|
| **SDE 理论统一**：将 DDPM、Score Matching、概率流 ODE 纳入统一框架，揭示了扩散过程的连续时间本质。**DDIM**：非马尔可夫采样将步数从 1000 降到 50-100 步。 | 降采样步数以质量损失为代价；仍然在像素空间操作，高分辨率（10242+）计算成本不可接受。条件机制仍很原始（需要额外分类器）。 |
...
| 模块 | 核心篇数 | 拓展篇数 | 核心论文 |
|------|---------|---------|---------|
| 01-扩散理论基础 | 2 | 3 | DDPM (2020) [[arXiv](https://arxiv.org/abs/2006.11239)], Score-based SDE (2021) [[arXiv](https://arxiv.org/abs/2011.13456)] |
| 02-骨干架构演进 | 5 | 4 | LDM (2022) [[arXiv](https://arxiv.org/abs/2112.10752)], DiT (2023) [[arXiv](https://arxiv.org/abs/2212.09748)], MMDiT/SD3 (2024) [[arXiv](https://arxiv.org/abs/2403.03206)], Flux (2024) [[Blog](https://blackforestlabs.ai/announcing-black-forest-labs/)], VAR (2024) [[arXiv](https://arxiv.org/abs/2404.02905)] |
| 03-条件注入机制 | 2 | 3 | CFG (2022) [[arXiv](https://arxiv.org/abs/2207.12598)], LDM §3.3 Cross-Attn (2022) |
| 04-可控生成与适配 | 3 | 3 | ControlNet (2023) [[arXiv](https://arxiv.org/abs/2302.05543)], LoRA (2022) [[arXiv](https://arxiv.org/abs/2106.09685)], Textual Inversion (2022) [[arXiv](https://arxiv.org/abs/2208.01618)] |
| 05-采样加速与蒸馏 | 4 | 4 | DDIM (2021) [[arXiv](https://arxiv.org/abs/2010.02502)], DPM-Solver (2022) [[arXiv](https://arxiv.org/abs/2206.00927)], LCM (2023) [[arXiv](https://arxiv.org/abs/2310.04378)], ADD (2024) [[arXiv](https://arxiv.org/abs/2311.17042)] |
| 06-多模态扩展 | 5 | 6 | DreamFusion/SDS (2023) [[arXiv](https://arxiv.org/abs/2209.14988)], SVD (2023) [[arXiv](https://arxiv.org/abs/2311.15127)], Sora (2024) [[OpenAI](https://openai.com/index/video-generation-models-as-world-simulators/)], Latte (2024) [[arXiv](https://arxiv.org/abs/2401.03055)], Direct3D (2024) [[arXiv](https://arxiv.org/abs/2405.14832)] |
